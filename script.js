...
const humidityVlueTxt = document.querySelector('.humidity-vlue-txt')
const windVlueTxt = document.querySelector('.wind-vlue-txt')
...
async function updateWeatherInfo(city) {
  ...
  humidityVlueTxt.textContent = humidity + '%'
  windVlueTxt.textContent = speed + ' m/s'
...
<div class="forecast-items">
                ...
                <img class="forecast-item-img" src="/assets/weather/${getWeatherIcon(
                  id
                )}">
